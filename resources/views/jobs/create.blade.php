<x-layout>
    ...
    'on-call' => 'on-call',
            ...
            <x-inputs.text id="contact_phone" name="contact_phone" label="contact_phone"
                           placeholder="Enter phone number"/>

            <x-inputs.text id="contact_email" name="contact_email" label="contact_email" placeholder="Enter email"
                           type="email"/>
